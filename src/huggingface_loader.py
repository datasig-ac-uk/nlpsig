...
class loadHF:
    ...
    def __init__(self, 
                 dataset_name="newspop", 
                 split_name="train" ):
        self.dataset_name = dataset_name
        self.split_name = split_name
        self.dataset = None
    
    def load_preprocessed_df(self, default_preprocess="newspop"):
        """
    ...
    def preprocess_df(self, default_preprocess="newspop"):
        if default_preprocess=="newspop":
            self.default_preproces_newspop()
    
    def default_preproces_newspop(self):
    ...
    def _list_default_datetimes(self):
