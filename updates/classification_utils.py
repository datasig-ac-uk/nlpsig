...
class Folds:
    ...
    def get_splits(self, df, x_data, y_data, test_fold, dev_size = 0.33):
        ...
        test_pids_ = torch.Tensor(df[(df.timeline_id.isin(timeline_test))]['postid'].tolist())
...
def testing(model, test_loader):
      ...
      with torch.no_grad():     
            ...
            for emb_t, labels_t in test_loader:
                  ...
                  pids_test_all = torch.cat([pids_test_all, emb_t[:, -1]])
      
      return predicted_all, labels_all, pids_test_all
